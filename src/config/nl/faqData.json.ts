...
export const faqData: FaqItem[] = [
  {
    question: "Dit is een nederlandse vraag in faqData1?",
  ...
  {
    question: "Dit is een nederlandse vraag in faqData2?",
  ...
  {
    question: 'Dit is een nederlandse vraag in faqData3?',
  ...
  {
    question: "Dit is een nederlandse vraag in faqData4?",
