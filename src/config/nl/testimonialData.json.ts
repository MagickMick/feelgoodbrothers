...
export const testimonialData: TestimonialItem[] = [
  {
    ...
    testimonial: `Ik ben blablaI'm not a front-end dev, but I wanted to rebuild my personal site with Astro. If you're in the same shoes,
  ...
  },
  {
    ...
    testimonial: `Ik ben blablaThe Blogsmith Pro theme is ridiculously well put together and documented.
  ...
  },
  {
    ...
    name: "Damiano L",
    title: "C++ Developer",
    testimonial: `Ik ben blablaCosmic Themes provides some of the best Astro themes out there. They are well designed, easy to customize and, 
  ...
  },
  {
    ...
    name: "David G",
    title: "Web Developer",
    testimonial: `Ik ben blablaIt's the cleanest template standup experience ever! I've never used Astro, but looking at the demo, code, it
  ...
  },
  {
    ...
    name: "Travis B",
    title: "Developer",
    testimonial: `Ik ben blablaCosmic themes are for webdevs and marketers who don't want to waste time reinventing the wheel. 
  ...
  },
  {
    ...
    testimonial: `Ik ben blablaMy step-dad is starting a construction business and we're looking through Astro themes right now for his website
