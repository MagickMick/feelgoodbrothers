...
**This would be dutch, except that I don't speak french and don't want to get something horribly wrong!** Content collections are subdivided into language folders like "src/content/blog/en" and "src/content/blog/nl".
